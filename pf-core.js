...
(function () {
  ...
  if (val("ctaBg") || val("ctaBorder") || val("ctaColor") ||
    ...
    if (mosaicRules.length)
      overrides.push(".sqpsblog-mosaic-pill { " + mosaicRules.join("; ") + " !important; }");
  }
